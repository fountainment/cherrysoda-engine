...
target_compile_features(fcpp PRIVATE cxx_std_14)
...
if(MSVC)
  ...
  target_compile_options(glsl-optimizer PRIVATE "$<$<CONFIG:Release>:/O1>")
...
if(LINUX)
  target_include_directories(shaderc PRIVATE bgfx/3rdparty/directx-headers/include/directx)
  target_include_directories(shaderc PRIVATE bgfx/3rdparty/directx-headers/include)
  target_include_directories(shaderc PRIVATE bgfx/3rdparty/directx-headers/include/wsl/stubs)
endif()
if(MSVC OR MINGW)
  target_include_directories(shaderc PRIVATE bgfx/3rdparty/directx-headers/include/directx)
endif()
