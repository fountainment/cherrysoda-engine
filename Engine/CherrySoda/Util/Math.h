...
#define CHERRYSODA_GETTER_SETTER_OF_TYPE(TYPE,NAME,VALUE) \
	CHERRYSODA_GETTER_SETTER_EX1(TYPE,NAME,VALUE,CHERRYSODA_NONE_OP,CHERRYSODA_NONE_OP)
...
#define CHERRYSODA_GETTER_SETTER_EX1(TYPE,NAME,VALUE,EXTRA_GET_OP,EXTRA_SET_OP) \
