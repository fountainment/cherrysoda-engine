...
#define CHERRYSODA_GETTER_SETTER_EX(NAME, VALUE, EXTRA_GET_OP, EXTRA_SET_OP) \
	...
	inline void NAME(const decltype(VALUE)& v)                               \
	{                                                                        \
		EXTRA_SET_OP;                                                        \
		VALUE = v;                                                           \
	}
...
#define CHERRYSODA_GETTER_SETTER_EX_OF_VEC3(NAME, VALUE, EXTRA_GET_OP, EXTRA_SET_OP) \
	...
	inline cherrysoda::Math::Vec3& NAME##Ref()                                       \
	{                                                                                \
		return VALUE;                                                                \
	}                                                                                \
	inline const cherrysoda::Math::Vec2 NAME##2D() const                             \
	{                                                                                \
		return cherrysoda::Math::Vec2(NAME());                                       \
	}                                                                                \
	inline void NAME(const cherrysoda::Math::Vec3& v)                                \
	{                                                                                \
		EXTRA_SET_OP;                                                                \
		VALUE = v;                                                                   \
	}                                                                                \
	inline void NAME(const cherrysoda::Math::Vec2& v)                                \
	{                                                                                \
		NAME(cherrysoda::Math::Vec3(v, NAME().z));                                   \
	}                                                                                \
	inline void NAME##2D(const cherrysoda::Math::Vec2& v)                            \
	{                                                                                \
		NAME(cherrysoda::Math::Vec3(v, NAME().z));                                   \
	}                                                                                \
	inline void Move##NAME(const cherrysoda::Math::Vec3& v)                          \
	{                                                                                \
		NAME(VALUE + v);                                                             \
	}                                                                                \
	inline void Move##NAME(const cherrysoda::Math::Vec2& v)                          \
	{                                                                                \
		NAME(VALUE + cherrysoda::Math::Vec3(v, 0.f));                                \
	}                                                                                \
	inline void Move##NAME##2D(const cherrysoda::Math::Vec2& v)                      \
	{                                                                                \
		NAME(VALUE + cherrysoda::Math::Vec3(v, 0.f));                                \
	}                                                                                \
	inline void Move##NAME##X(float x)                                               \
	{                                                                                \
		NAME##X(VALUE.x + x);                                                        \
	}                                                                                \
	inline void Move##NAME##Y(float y)                                               \
	{                                                                                \
		NAME##Y(VALUE.y + y);                                                        \
	}                                                                                \
	inline void Move##NAME##Z(float z)                                               \
	{                                                                                \
		NAME##Z(VALUE.z + z);                                                        \
	}                                                                                \
	inline float NAME##X() const                                                     \
	{                                                                                \
		EXTRA_GET_OP;                                                                \
		return VALUE.x;                                                              \
	}                                                                                \
	inline float NAME##Y() const                                                     \
	{                                                                                \
		EXTRA_GET_OP;                                                                \
		return VALUE.y;                                                              \
	}                                                                                \
	inline float NAME##Z() const                                                     \
	{                                                                                \
		EXTRA_GET_OP;                                                                \
		return VALUE.z;                                                              \
	}                                                                                \
	inline void NAME##X(float x)                                                     \
	{                                                                                \
		NAME(cherrysoda::Math::Vec3(x, VALUE.y, VALUE.z));                           \
	}                                                                                \
	inline void NAME##Y(float y)                                                     \
	{                                                                                \
		NAME(cherrysoda::Math::Vec3(VALUE.x, y, VALUE.z));                           \
	}                                                                                \
	inline void NAME##Z(float z)                                                     \
	{                                                                                \
		NAME(cherrysoda::Math::Vec3(VALUE.x, VALUE.y, z));                           \
	}
...
#define CHERRYSODA_GETTER_SETTER_EX_OF_VEC2(NAME, VALUE, EXTRA_GET_OP, EXTRA_SET_OP) \
	...
	inline cherrysoda::Math::Vec2& NAME##Ref()                                       \
	{                                                                                \
		return VALUE;                                                                \
	}                                                                                \
	inline void NAME(const cherrysoda::Math::Vec2& v)                                \
	...
	inline void NAME##X(float x)                                                     \
	{                                                                                \
		NAME(cherrysoda::Math::Vec2(x, VALUE.y));                                    \
	}                                                                                \
	inline void NAME##Y(float y)                                                     \
	{                                                                                \
		NAME(cherrysoda::Math::Vec2(VALUE.x, y));                                    \
	}
...
public:
	...
	struct IRectangle
	{
		...
		{
			return m_coord == rect.m_coord && m_size == rect.m_size;
		}
		inline bool operator!=(const IRectangle& rect) const
		{
			return m_coord != rect.m_coord || m_size != rect.m_size;
	...
	template<typename T> static inline int BitCount_(T x)
	{
		int ret = 0;
		while (x) {
			x &= ~(x & (-x));
