...
const Easer Ease::SineIn = [](float t) { return -Math_Cos(Math::PiHalf * t) + 1.f; };
const Easer Ease::SineOut = [](float t) { return Math_Sin(Math::PiHalf * t); };
const Easer Ease::SineInOut = [](float t) { return (-Math_Cos(Math::Pi * t) * .5f) + .5f; };
...
const Easer Ease::ExpoIn = [](float t) { return Math_Pow(2.f, 10.f * (t - 1.f)); };
