...
static STL::HashMap<int, const char*> s_debugEventLookUp = {ENUM_NAME_PAIR(SDL_EVENT_QUIT),
...
static STL::HashMap<int, Keys> s_keycodeToKeys = {{(int)SDLK_A, Keys::A},
												  {(int)SDLK_B, Keys::B},
												  {(int)SDLK_C, Keys::C},
												  {(int)SDLK_D, Keys::D},
												  {(int)SDLK_E, Keys::E},
...
static STL::HashMap<int, Keys> s_scancodeToKeys = {{(int)SDL_SCANCODE_A, Keys::A},
