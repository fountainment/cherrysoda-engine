...
TEST(CollideTestRectToPoint, Boundaries)
{
	...
	EXPECT_TRUE(Collide::RectToPoint(Math::Rectangle{Math::Vec2(2.f,3.f),Math::Vec2(4.f,5.f)},Math::Vec2(3.f,4.f)));
	EXPECT_FALSE(Collide::RectToPoint(Math::Rectangle{Math::Vec2(2.f,3.f),Math::Vec2(4.f,5.f)},Math::Vec2(6.f,4.f)));
}
